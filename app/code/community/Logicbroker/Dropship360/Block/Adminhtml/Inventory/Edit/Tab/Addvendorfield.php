...
class Logicbroker_Dropship360_Block_Adminhtml_Inventory_Edit_Tab_Addvendorfield extends Mage_Adminhtml_Block_Widget
{
    ...
    public function getVendorSelectHtml()
    {
    	...
    	//$html = '<select name=\"'.$this->getFieldName().'[{{id}}][vendor_id]\" id=\"'.$this->getFieldId().'_{{id}}_vendor_id"\ class=\"select-vendor-option-type required-entry validate-select select"\><option value="1">my code</option><option value="2">your code</option></select>';
    	//return $html;
    }
