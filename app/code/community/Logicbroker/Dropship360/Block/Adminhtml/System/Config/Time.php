...
class Logicbroker_Dropship360_Block_Adminhtml_System_Config_Time extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
	{
		...
		$selectedHourValue = Mage::getStoreConfig('logicbroker_cron/cron_settings/schedule_backorder_hour');
		$selectedMinValue = Mage::getStoreConfig('logicbroker_cron/cron_settings/schedule_backorder_min');
		...
		$nameMin = str_replace("schedule_backorder","schedule_backorder_min",$element->getName());
			...
			$selectedHourValue = Mage::getStoreConfig('logicbroker_cron/cron_settings/schedule_sourcing_hour');
			$selectedMinValue = Mage::getStoreConfig('logicbroker_cron/cron_settings/schedule_sourcing_min');
			$idHour = $element->getHtmlId().'_hour';
